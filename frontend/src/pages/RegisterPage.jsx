      ...
      <div className="w-full max-w-md">
        <div className="glass-panel border-slate-200/60 rounded-3xl p-8 sm:p-10 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-slate-500">Join us to access member-only perks and simple checkouts</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <User className="absolute left-4 top-3.5 w-4 h-4 text-slate-450" />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-primary-premium py-3.5 rounded-2xl flex items-center justify-center gap-2 mt-6 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
